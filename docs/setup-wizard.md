...
5. **Transcription** — record one utterance and see what the on-device
   ...
   pre-seed step. Also here: the **streaming transcription** toggle
   (transcribe while you speak — needs a tiny/small/medium model, see
   [moonshine.md](moonshine.md)) and the **end-of-speech silence** window
